...
//        if (!request.getPassword().equals(user.getPassword())){throw new CustomException(ExceptionCode.NOT_MATCHES_PASSWORD);}

        String bearerToken = jwtUtil.generateToken(user.getEmail());
